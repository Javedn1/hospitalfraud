...
<div id="templatemo_content_top_wrapper">
    ...
    <div id="templatemo_content_top">
        ...
        <div class="header_01" align="center"><b>Welcome To Fraud Detection In Hospital Management System</b></div>
          ...
          <form action="searchHospitalRes.jsp" method="post">
           <div ng-controller="CountryCntrl">
    		    <div>
                	...
                	<b>City:</b><select id="subject" name="subject" ng-disabled="!cities || !states" ng-model="city"><option value=''>Select</option> <option ng-repeat="city in cities" value='{{city}}'>{{city}}</option></select> <br>       
            	</div><br>
            	<b>Hospital Name(OR): </b><input type="text" name="hospitalname" id="hospitalname">
            	<br>
            	<input type="submit" value="Search" id="submit" placeholder="submit" required / ><br><br><br><br><br><br><br>
        		</div>
