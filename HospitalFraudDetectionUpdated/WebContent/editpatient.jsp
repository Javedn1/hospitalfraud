...
<div id="templatemo_content_top_wrapper">
    ...
    <div id="templatemo_content_top">
       ...
       <center>
       <form action="EditPatient" method="post" onsubmit="return validate()">
     ...
     <tr>
     <th style="color: red;"> Set New Password </th><td><input type="password" name="password" id="password" placeholder="Password"></input></td>
     </tr>
     <tr>
     <td><input class="input-rounded-button" type="submit" value="Update" style="height: 30px;width: 80px;"/></td></a></td>
     </tr>       
     </table>
       </form>
       </center>
