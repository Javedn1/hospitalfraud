...
<!-- Free Web Templates from TemplateMo.com -->
    <div id="templatemo_header">
        ...
        <div id="templatemo_menu">
            <ul>
                <li><a href="aminhome.jsp" class="current"><span></span>Home</a></li>
...
<div id="templatemo_content_top_wrapper">
 ...
 %>
			...
			<h3>click on request button to send request to admin to view file</h3>
...
<div id="templatemo_footer_wrapper">
    ...
    <div align=center>Welcome To The Privacy Protection For Wireless Sensor Data <!--  <a href='http://all-free-download.com/free-website-templates/'>free website templates</a> -->
