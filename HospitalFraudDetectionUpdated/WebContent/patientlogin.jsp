...
<div id="templatemo_content_top_wrapper">
    ...
    <div id="templatemo_content_top">
       ...
       <center>
       <form action="PatientLogin" method="post" onsubmit="return validate()">
     ...
     <tr>
     <td><input class="input-rounded-button" type="submit" value="LogIn" style="height: 30px;width: 80px;"/></td><td><a href="patientregister.jsp"><img src="images/adduser.png" width="50" height="50" alt=""></img></a></td>
     </tr>
     </table>
       </form>
       </center>
