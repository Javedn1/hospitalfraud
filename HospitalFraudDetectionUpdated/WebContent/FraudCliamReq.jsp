...
<!-- Free Web Templates from TemplateMo.com -->
    <div id="templatemo_header">
        ...
        <div id="templatemo_menu">
            <ul>
                <li><a href="policehome.jsp" class="current"><span></span>Home</a></li>
                
                <li><a href=".jsp"><span></span>View Fraud Claim Request</a></li>
...
<center>
		<table border="0" cellspacing="5" cellpadding="10" style=" border:2px solid red;" >
			...
			<tr>
			   <th style="color: black;">Request Id</th>			
               <th style="color: black;">Cliam Id</th>
        ...
        ResultSet rs = st.executeQuery("select * from policerequest");
        while(rs.next()){
