    ...
    <div id="templatemo_header">
        ...
        <div id="templatemo_menu">
            ...
            <li><a href="index.jsp" class="current"><span></span>Home</a></li>
                ...
                <li><a href="doctorlogin.jsp" ><span></span>Hospital</a></li>
    ...
    <div id="templatemo_content_top">
        ...
        <table align="center">
				...
				<td>
				 ...
				 <td><span style="font-size:22px; color: red;"><h3>Hospital Login</h3></span></td>
				 </tr>
            </table>
       <center>
       <form action="DoctorLogin" method="post" onsubmit="return validate()">
     ...
     <tr>
     <td><input class="input-rounded-button" type="submit" value="LogIn" style="height: 30px;width: 80px;"/></td><td><a href="doctorregister.jsp"><img src="images/adduser.png" width="50" height="50" alt=""></img></a></td>
     </tr>
     </table>
       </form>
       </center>
